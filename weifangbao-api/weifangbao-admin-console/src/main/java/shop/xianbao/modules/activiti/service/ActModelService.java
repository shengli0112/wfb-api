...
package shop.xianbao.modules.activiti.service;
...
public class ActModelService {
    ...
    public void deploy(String id) {
        try {
            ...
            if (list.size() == 0) {
                throw new XianbaoException(ErrorCode.ACT_DEPLOY_ERROR);
            }
        } catch (Exception e) {
            throw new XianbaoException(ErrorCode.ACT_MODEL_IMG_ERROR, e);
        }
    }
    ...
    public void export(String id, HttpServletResponse response) {
        try {
            ...
            throw new XianbaoException(ErrorCode.ACT_MODEL_EXPORT_ERROR, id);
        }
    }
