...
public class ReportController {
    ...
    public Result<PageData<ReportListDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params) {
        PageData<ReportListDTO> page = reportService.page(params);
    ...
    public Result add(@RequestBody ReportDTO dto) {
        //效验数据
