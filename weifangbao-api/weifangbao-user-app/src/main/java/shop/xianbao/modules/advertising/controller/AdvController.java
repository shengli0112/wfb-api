...
public class AdvController {
    ...
    @ApiOperation("分页")
    public Result<List<AdvListDTO>> listByPosition(@ApiIgnore @RequestParam Map<String, Object> params) {
        List<AdvListDTO> list = advService.list(params);
        return new Result<List<AdvListDTO>>().ok(list);
    }
    ...
    public Result<PageData<AdvListDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params) {
        PageData<AdvListDTO> page = advService.page(params);

        return new Result<PageData<AdvListDTO>>().ok(page);
    }
