...
public class MessageUserController {
    ...
    public Result<PageData<MessageUserListDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params, @LoginUser MemberDataEntity user) {
    ...
    @ApiOperation("是否有新消息")
    public Result info(@PathVariable Long messageId, @LoginUser MemberDataEntity user) {
        return messageService.messageInfo(messageId, user);
    }
    ...
    @ApiOperation("是否有新消息")
    public Result hasNewMessage(@LoginUser MemberDataEntity user) {
        Long unionId = null;
        if (!Objects.equals(null, user)) {
            unionId = user.getUnionId();
        }
        int result = messageUserService.hasNewMessage(unionId);
    ...
    @PostMapping("readAll")
    @ApiOperation("是否有新消息")
    public Result readAll(@LoginUser MemberDataEntity user) {
        return messageUserService.readAll(user);
    }
