...
package shop.xianbao.modules.oss.controller;
...
import shop.xianbao.common.validator.group.QiniuGroup;
import shop.xianbao.modules.oss.cloud.CloudStorageConfig;
import shop.xianbao.modules.oss.cloud.OSSFactory;
...
public class SysOssController {
    ...
    public Result<Map<String, Object>> upload(@RequestParam("file") MultipartFile file) throws Exception {
        ...
        if (StringUtils.isNotBlank(extension)) {
            extension = DigestUtils.md5Hex(file.getBytes()) + "." + extension;
        } else {
            extension = DigestUtils.md5Hex(file.getBytes());
        }
