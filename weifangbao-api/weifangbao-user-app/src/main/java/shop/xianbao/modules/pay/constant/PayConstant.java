package shop.xianbao.modules.pay.constant;
...
public class PayConstant {
    ...
    // 支付中
    public final static Integer PAY_STATUS_PAYING = 1;

    // 支付成功
    public final static Integer PAY_STATUS_SUCCESS = 2;

    // 支付失败
    public final static Integer PAY_STATUS_FAILED = 3;

    // 订单过期
    public final static Integer PAY_STATUS_EXPIRED = 4;

    // 初始态
    public final static Integer TRANS_STATUS_INIT = 0;

    // 转账中
    public final static Integer TRANS_STATUS_TRANING = 1;

    // 成功
    public final static Integer TRANS_STATUS_SUCCESS = 2;

    // 失败
    public final static Integer TRANS_STATUS_FAIL = 3;

    // 业务完成
    public final static Integer TRANS_STATUS_COMPLETE = 4;

    // 不确认结果
    public final static Integer TRANS_RESULT_INIT = 0;

    // 等待手动处理
    public final static Integer TRANS_RESULT_REFUNDING = 1;

    // 确认成功
    public final static Integer TRANS_RESULT_SUCCESS = 2;

    // 确认失败
    public final static Integer TRANS_RESULT_FAIL = 3;

    // 初始态
    public final static Integer REFUND_STATUS_INIT = 0;

    // 转账中
    public final static Integer REFUND_STATUS_REFUNDING = 1;

    // 成功
    public final static Integer REFUND_STATUS_SUCCESS = 2;

    // 失败
    public final static Integer REFUND_STATUS_FAIL = 3;

    // 业务完成
    public final static Integer REFUND_STATUS_COMPLETE = 4;

    // 不确认结果
    public final static Integer REFUND_RESULT_INIT = 0;

    // 等待手动处理
    public final static Integer REFUND_RESULT_REFUNDING = 1;

    // 确认成功
    public final static Integer REFUND_RESULT_SUCCESS = 2;

    // 确认失败
    public final static Integer REFUND_RESULT_FAIL = 3;
    ...
    // 通知中
    public final static Integer MCH_NOTIFY_STATUS_NOTIFYING = 1;

    // 通知成功
    public final static Integer MCH_NOTIFY_STATUS_SUCCESS = 2;

    // 通知失败
    public final static Integer MCH_NOTIFY_STATUS_FAIL = 3;
    ...
    public static class PayType {
         ...
         * 1、 余额充值
         */
        public final static Integer BALANCE = 1;

        /**
         * 2、订单支付
         */
        public final static Integer PAY_ORDER = 2;
    ...
    public static class WxConstant {
         ...
         * 微信支付类型
         */
        public final static Integer PAY_MODE = 2;

        public final static String PAY_MODE_NAME = "微信";
    ...
    public static class AliPayConstant {
        ...
        public final static Integer PAY_MODE = 1;

        public final static String RESULT_STATUS_SUCCESS = "9000";
        ...
        public static final String PAY_MODE_NAME = "支付宝";
    }
