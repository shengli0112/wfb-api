...
public class EntPayController {
    ...
    public EntPayController() {
        //      this.wxService = WxPayUtil.getWxPayService();
    }
     ...
     * @throws WxPayException the config config exception
     */
     ...
     *
     * @param request 请求对象
     * @return the ent config bank result
     * @throws WxPayException the config config exception
     */
     ...
     *
     * @param partnerTradeNo 商户订单号
     * @return the ent config bank query result
     * @throws WxPayException the config config exception
     */
