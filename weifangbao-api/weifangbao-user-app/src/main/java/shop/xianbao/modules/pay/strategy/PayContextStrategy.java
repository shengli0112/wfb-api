...
public class PayContextStrategy {
    ...
    public JSONObject pay(PayParamDTO payParamDTO) {
        PayTypeEntity payTypeEntity = payTypeService.getPayTypeByCode(payParamDTO.getPayCode(), payParamDTO.getTradeType());
        PayStrategy payStrategy = getPayStrategy(payTypeEntity);
        return payStrategy.pay(payTypeEntity, payParamDTO);
    }
