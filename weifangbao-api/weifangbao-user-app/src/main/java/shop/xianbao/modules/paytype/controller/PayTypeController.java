...
public class PayTypeController {
    ...
    @GetMapping("/list")
    @ApiOperation("列表")
    public Result<List<PayTypeRealNameListDTO>> list(@ApiIgnore @LoginUser MemberDataEntity user) {
        List<PayTypeRealNameListDTO> list = payTypeService.payTypeList(user);

        return new Result<List<PayTypeRealNameListDTO>>().ok(list);
    }
