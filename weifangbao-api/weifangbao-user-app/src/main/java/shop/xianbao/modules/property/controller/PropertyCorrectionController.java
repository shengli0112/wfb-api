 ...
 */
@RestController
@RequestMapping("property/correction")
@Api(tags = "楼盘纠错表")
public class PropertyCorrectionController {
    ...
    @RequiresPermissions("property:correction:page")
    ...
    @RequiresPermissions("property:correction:list")
    ...
    @ApiOperation("下拉列表")
    @RequiresPermissions("property:correction:comboList")
    ...
    @GetMapping("{id}")
    @ApiOperation("详细信息")
    @RequiresPermissions("property:correction:info")
    ...
    @ApiOperation("新增")
    @LogOperation("新增")
    @RequiresPermissions("property:correction:add")
    public Result add(@RequestBody PropertyCorrectionDTO dto, @LoginUser MemberDataEntity user) {
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);
        return propertyCorrectionService.add(dto, user);
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("property:correction:update")
    public Result update(@RequestBody PropertyCorrectionDTO dto) {
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        propertyCorrectionService.update(dto);
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("property:correction:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("property:correction:export")
