package shop.xianbao.common.elink.api;

import shop.xianbao.common.elink.config.ApiConst;
...
public class ELinkAPI {
     ...
     * @param id           UUID4 详见API文档列表-uuid4
     * @param timestamp    当前服务器时间戳(10位)
     * @param print_name   自定义打印机名称
     * @return
     */
    public static String addPrinter(String client_id, String machine_code, String msign, String access_token, String sign, String id, String timestamp, String print_name) {
        HashMap hashMap = new HashMap();
        hashMap.put("client_id", client_id);
        hashMap.put("machine_code", machine_code);
    ...
    public static String getSin(String clientId, String clientSecret, String timestamp) {
        try {
